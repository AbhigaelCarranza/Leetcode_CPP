...
//Lección "Insertar Nodo Ordenado"
...
//Lección "Métodos para mostrar nodos (INORDEN, POSTORDEN y PREORDEN)"
...
void searchNodeTree(int number, bool remove) 
{
    ...
    if (searching == NULL) cout << endl << "Node " << number << " not found" << endl;
    else 
    {
